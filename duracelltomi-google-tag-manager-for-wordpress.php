...
/**
 * Google Tag Manager for WordPress (versione modificata hextra)
 *
 * @package GTM4WP
 ...
 *
 * @wordpress-plugin
 * Plugin Name: GTM4WP - A Google Tag Manager (GTM) plugin for WordPress (versione modificata hextra)
